...
#loading the model ***
model = load_model('Your_Model.h5') #instead you can use pretrained model just replace the name and put the name of the model which i have made and saved in the directory
